...
export function toCompanySnapshotRows({
  ...
  for (const company of companies ?? []) {
    ...
    rowBySymbol.set(symbol, {
      ...
      price,
      symbol,
      change7dPercent: toFiniteNumber(company.change7dPercent),
      change52wPercent: toFiniteNumber(company.change52wPercent),
      dayHigh: toFiniteNumber(company.day_high),
      dayLow: toFiniteNumber(company.day_low),
      high52wk: toFiniteNumber(company.high52wk),
      low52wk: toFiniteNumber(company.low52wk),
